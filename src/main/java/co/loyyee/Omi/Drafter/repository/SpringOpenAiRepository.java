...
public class SpringOpenAiRepository
    ...
    private SpringOpenAiRepository promptInitialHeader() {
        ...
        var header = sb
            .append("Generate new cover letter for job application. ")
            ...
            .append(
                "3rd: good fit and able to contribute with my work experience and skills."
            )
            .append("4th: soft skills good fit for the company ")
            .append(
                "5th: looking forward to the interview and contribute to the company. "
            )
            .append(
