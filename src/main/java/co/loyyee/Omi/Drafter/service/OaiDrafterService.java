...
public class OaiDrafterService {
    ...
    public void promptInitialHeader() {
        ...
        header
            .append(
                "You will help me to draft a NEW cover letter and help me to land an interview. "
            )
            .append(
                "first paragraph about me, and why I am interested in the position, and education background and GPA. "
            )
            .append(
                "second paragraph is about how good the company culture is "
            )
            .append(
                "third paragraph work experience and skill set will contribute to the company "
            )
            .append("but don't output anything, wait for my input.");

        OpenAiService service = new OpenAiService(
            this.apiKey,
            Duration.ofSeconds(this.durationSecs)
        );
        ChatMessage systemMessages = new ChatMessage(
        ...
        try {
            var value = service
                ...
                .filter(
                    el ->
                        el.getChoices().get(0).getMessage().getContent() != null
                )
    ...
    public void promptHeaderDesc() {
        ...
        header
            ...
            .append(
                "fifth paragraph looking forward to the interview and " +
                "opportunity to work with the company. "
            )
            .append(
                "last paragraph thanks the hiring manager for taking the time, " +
                "and including the my contact information and as them to contact me. "
            )
            .append("but don't output anything, wait for my input.");
